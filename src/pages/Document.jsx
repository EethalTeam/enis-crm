...
function Document() {
    ...
    const getAllDocument = async () => {
        try {
            setLoading(true);
            let url = config.Api + "Document/getAllDocument";
    ...
    const createDocument = async (data) => {
        let url = config.Api + "Document/createDocument";
        const res = await fetch(url, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    const updateDocument = async (data) => {
        let url = config.Api + "Document/updateDocument";
        const res = await fetch(url, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data),
    ...
    const deleteDocument = async (_id) => {
        let url = config.Api + "Document/deleteDocument";
        const res = await fetch(url, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    // ------------------- VALIDATE -------------------
    const Validate = () => {
        if (!state.documentCode) {
            toast({
                title: "Error",
                description: "Enter Document Code",
                variant: "destructive",
            });
            return;
        }
    ...
    const triggerConfirm = (type) => {
        setConfirmState({
            open: true,
            title: type === "Update" ? "Update Document?" : "Create Document?",
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-slate-700">
                                    <th className="py-3 px-4 text-left">Document Code</th>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        storeDispatch(e.target.value, "documentCode")
                                    }
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        storeDispatch(e.target.value, "documentName")
                                    }
                                />
                            </div>
                        </div>
